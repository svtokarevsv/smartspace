            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mb1">
                        <a href="<?=ROOT_URI?>profile/edit">
                            <button type="button" class="btn btn-azure col-md-12">Edit Profile</button>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="<?=ROOT_URI?>resume">
                            <button type="button" class="btn btn-azure col-md-12">View my Resume</button>
                        </a>
                    </div>
                </div>
